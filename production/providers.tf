...
provider "databricks" {
  host                        = module.data-workflow.databricks_workspace_url != "" ? module.data-workflow.databricks_workspace_url : data.terraform_remote_state.foo.outputs.databricks_workspace_url
